...
public class CuratedLists_Test extends PlaywrightFactory{
	...
	{	
		...
		clickElement(curatedList.mnuCuratedLists);
		clickElement(curatedList.lnkViewAll);
		clickElement(curatedList.curatedListItem);
		clickElement(curatedList.SelectAll);
		clickElement(curatedList.addToCartdrpdwn);
		curatedList.addToCart();
